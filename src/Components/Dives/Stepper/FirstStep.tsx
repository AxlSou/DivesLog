...
const FirstStep = () => {
    ...
    return (
        <>
            ...
            <h6>Depth/Time</h6>
            <Stack spacing={3}>
                <TextField id="max-depth" label="Max Depth" variant="outlined" size="small" placeholder="How deep did you go? (meters)" required/>
                <TextField id="bottom-time" label="Bottom Time" variant="outlined" size="small" placeholder="How long was your dive? (mins)" required/>
            </Stack>
        </>
    )
}
